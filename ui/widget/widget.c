...
widget_t widget_data[] = {
  ...
  { widget_internals_loaders_draw,	  widget_options_finish, widget_internals_loaders_keyhandler    },
  { widget_internals_sound_draw,	  widget_options_finish, widget_internals_sound_keyhandler    },
  { widget_error_draw,	  NULL,			 widget_error_keyhandler    },
  { widget_recording_rzx_draw,      widget_options_finish, widget_recording_rzx_keyhandler      },
  { widget_recording_movie_draw,    widget_options_finish, widget_recording_movie_keyhandler    },
  ...
  { widget_peripherals_devices_draw, widget_options_finish, widget_peripherals_devices_keyhandler },
  { widget_peripherals_sound_draw, widget_options_finish, widget_peripherals_sound_keyhandler },
  { widget_peripherals_storages_draw, widget_options_finish, widget_peripherals_storages_keyhandler },
  ...
  { widget_internals_diskettes_draw, widget_options_finish, widget_internals_diskettes_keyhandler  },
