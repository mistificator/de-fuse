...
void handle_menu( DWORD cmd, HWND okno )
{
  switch( cmd )
  {
    ...
    case IDM_MENU_OPTIONS_SELECTROMS_INTERFACEI:
      menu_options_selectroms_select( 16 ); break;
    case IDM_MENU_OPTIONS_SELECTROMS_BETA128:
      menu_options_selectroms_select( 17 ); break;
    case IDM_MENU_OPTIONS_SELECTROMS_D:
      menu_options_selectroms_select( 18 ); break;
